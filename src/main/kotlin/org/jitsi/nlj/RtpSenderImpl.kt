...
class RtpSenderImpl(
    ...
    private val incomingPacketQueue = PacketInfoQueue("rtp-sender-incoming-packet-queue", executor, this::handlePacket, RtpSenderConfig.Config.rtpSenderQueueSizeProperty())
    var running = true
