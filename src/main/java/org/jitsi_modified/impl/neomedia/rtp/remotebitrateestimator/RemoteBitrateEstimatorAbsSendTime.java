...
public class RemoteBitrateEstimatorAbsSendTime
{
        ...
        int payloadSize)
    {
        ...
        // needs to be reset.
        long incomingBitrate_ = (long) incomingBitrate.getRate(arrivalTimeMs);
        ...
        {
            long incomingRate_ = (long) incomingBitrate.getRate(arrivalTimeMs);
        ...
        if (updateEstimate)
        {
            ...
            input.incomingBitRate = (long) incomingBitrate.getRate(arrivalTimeMs);
